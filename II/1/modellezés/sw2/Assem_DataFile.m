...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [3.1891156382357622e-13 -2.9999999999998197 9.1835348162193];  % mm
...
smiData.RevoluteJoint(1).Rz.Pos = -177.09931176305668;  % deg
