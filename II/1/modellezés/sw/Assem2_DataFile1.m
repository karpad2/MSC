...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [125 450.00000000000063 -24.99999999998899];  % mm
smiData.RigidTransform(6).angle = 1.570796326794921;  % rad
smiData.RigidTransform(6).axis = [1 0 0];
smiData.RigidTransform(6).ID = 'RootGround[rud-1]';
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 0.00098174770424711661;  % kg
smiData.Solid(2).CoM = [0 25 0];  % mm
smiData.Solid(2).MoI = [0.20606475250603593 0.0030679615757731966 0.20606475250603593];  % kg*mm^2
smiData.Solid(2).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(2).color = [0.50588235294117645 0.52941176470588236 0.5490196078431373];
smiData.Solid(2).opacity = 1;
smiData.Solid(2).ID = 'rud*:*Default';
