...
smiData.RigidTransform(1).translation = [0 8.4226455100083761 9.183534816219419];  % mm
smiData.RigidTransform(1).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(1).axis = [0.57735026918962584 -0.57735026918962584 0.57735026918962584];
smiData.RigidTransform(1).ID = 'B[inga_2-1:-:rud2-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [-7.1054273576010019e-14 -13.577354489991635 2.1671553440683056e-13];  % mm
smiData.RigidTransform(2).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(2).axis = [0.57735026918962584 -0.57735026918962584 0.57735026918962584];
smiData.RigidTransform(2).ID = 'F[inga_2-1:-:rud2-1]';
...
smiData.RigidTransform(3).ID = 'B[alap-1:-:rud2-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [0 -894.21359874900611 0];  % mm
smiData.RigidTransform(4).angle = 2.0943951023931953;  % rad
smiData.RigidTransform(4).axis = [-0.57735026918962562 -0.57735026918962562 -0.57735026918962595];
smiData.RigidTransform(4).ID = 'F[alap-1:-:rud2-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [0 0 0];  % mm
smiData.RigidTransform(5).angle = 1.5707963267948724;  % rad
smiData.RigidTransform(5).axis = [-1 0 0];
smiData.RigidTransform(5).ID = 'RootGround[alap-1]';

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [125 450.00000000000125 -49.999999999988987];  % mm
smiData.RigidTransform(6).angle = 1.570796326794921;  % rad
smiData.RigidTransform(6).axis = [1 0 0];
smiData.RigidTransform(6).ID = 'RootGround[rud2-1]';
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(3).mass = 0.0019634954084942337;  % kg
smiData.Solid(3).CoM = [0 25.000000000000004 0];  % mm
smiData.Solid(3).MoI = [1.6393141353209681 0.0061359231515463932 1.6393141353209681];  % kg*mm^2
smiData.Solid(3).PoI = [0 0 0];  % kg*mm^2
smiData.Solid(3).color = [0.50588235294117645 0.52941176470588236 0.5490196078431373];
smiData.Solid(3).opacity = 1;
smiData.Solid(3).ID = 'rud2*:*Default';
...
smiData.RevoluteJoint(1).Rz.Pos = -1.733648499949662;  % deg
smiData.RevoluteJoint(1).ID = '[inga_2-1:-:rud2-1]';

smiData.RevoluteJoint(2).Rz.Pos = 180;  % deg
smiData.RevoluteJoint(2).ID = '[alap-1:-:rud2-1]';
